    ...
    <header className="sticky top-0 z-40 border-b border-navy/10 bg-cream/95 backdrop-blur">
      <div className="mx-auto flex min-h-20 max-w-7xl items-center justify-between gap-6 px-5 sm:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="outline" size="icon" className="border-navy/20 text-navy xl:hidden" aria-label={open ? 'Close menu' : 'Open menu'} aria-expanded={open} aria-controls="mobile-navigation" onClick={() => setOpen((current) => !current)}>
      ...
      {open && (
        <div id="mobile-navigation" className="border-t border-navy/10 bg-cream px-5 py-5 sm:px-8 xl:hidden">
